Public Class retencion_info_detalle
    Private XmlForm As String = Replace(Application.StartupPath & "\retencion_info_detalle.srf", "\\", "\")
    ...
    Public Sub New()
        ...
        Try
            ...
            If UDT_UF.ActivateFormIsOpen(SBO_Application, "dIft") = False Then
                LoadFromXML(XmlForm)
                oForm = SBO_Application.Forms.Item("dIft")
                oForm.Left = 400
                oForm.Visible = True
                oForm.PaneLevel = 1
            ...
            Else
                oForm = Me.SBO_Application.Forms.Item("dIft")
            End If
            visualizardata()
