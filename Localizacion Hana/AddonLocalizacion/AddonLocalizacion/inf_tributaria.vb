...
Public Class inf_tributaria
    ...
    Private Sub SBO_Application_ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean) Handles SBO_Application.ItemEvent
        Try
            ...
            If pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE And pVal.BeforeAction = True And pVal.FormUID = "frm_inf" Then
                oForm = Nothing
                oCompany = Nothing
                SBO_Application = Nothing
            End If

            If pVal.FormUID = "frm_inf" Then
    ...
    Private Sub cargar()
        ...
        Try
            ...
            orecord.DoQuery("SELECT * FROM " & Chr(34) & "@INF_TRIBUTARIA" & Chr(34))
            ...
            Try
                orecord = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                Dim sql = "SELECT IFNULL(A." & Chr(34) & "U_FECHA" & Chr(34) & ",'N') FROM  " & Chr(34) & "@INF_APP" & Chr(34) & " A "
                orecord.DoQuery(sql)
