        ...
        Try
            ...
            If oRecord.RecordCount > 0 Then
                ...
                While oRecord.EoF = False
                    ...
                    createNode("codigoAuxiliar", oRecord.Fields.Item("codigoAuxiliar").Value.ToString, writer)
                    ...
                    oRecord2.DoQuery("CALL SP_DETALLEADICIONALES ('" & DocEntry & "','13','" & oRecord.Fields.Item(0).Value.ToString & "')")
            ...
            oRecord = oCompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            Dim en = "CALL SP_INFOADICIONAL ('" & DocEntry & "','13')"
            oRecord.DoQuery(en)
            If oRecord.RecordCount > 0 Then
            ...
            If My.Computer.FileSystem.FileExists(Application.StartupPath & "\CONFIGURACION.xml") = True Then
                ...
                Next
                My.Computer.Network.UploadFile(va, Lista(0).ToString & "Comprobante (F) No." & DocEntry.ToString & ".xml", Lista(1).ToString, Lista(2).ToString, True, 2500, FileIO.UICancelOption.DoNothing)
            End If
